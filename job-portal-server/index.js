...
//user: saipatnam99
// pwd:NncTMcFQNqKuJXPo


const { MongoClient, ServerApiVersion, ObjectId, } = require('mongodb') ;
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@job-portal-demo.idngazh.mongodb.net/?retryWrites=true&w=majority&appName=job-portal-demo`;
